...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-surface-900 overflow-x-hidden">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-surface-200/80 bg-white/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between gap-2">
          ...
          <nav className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <a href="#how-it-works" className="text-sm font-medium text-surface-600 dark:text-surface-300 hover:text-surface-900 dark:text-surface-50 transition-colors whitespace-nowrap">
              How it works
            </a>
            <a href="#for-teams" className="text-sm font-medium text-surface-600 dark:text-surface-300 hover:text-surface-900 dark:text-surface-50 transition-colors whitespace-nowrap">
              For teams
            </a>
          </nav>
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <button
              ...
              className="text-sm font-medium text-surface-600 dark:text-surface-300 hover:text-surface-900 dark:text-surface-50 transition-colors hidden sm:block py-2 px-3 -my-2 -mx-3 rounded-lg hover:bg-surface-50 dark:hover:bg-surface-800 dark:bg-surface-900"
            >
              Log in
            </button>
      ...
      {/* Hero */}
      <section className="pt-20 pb-12 sm:pt-24 sm:pb-16 lg:pt-28 lg:pb-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-surface-900">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-brand-600 font-medium text-xs sm:text-sm uppercase tracking-wider">
            Time tracking & payroll
          </p>
          <h1 className="mt-2 sm:mt-3 text-2xl sm:text-4xl lg:text-5xl font-bold text-surface-900 dark:text-surface-50 tracking-tight leading-tight">
            One place to clock in, track hours, and run payroll.
          </h1>
          <p className="mt-4 sm:mt-5 text-base sm:text-lg text-surface-600 dark:text-surface-300 px-0 sm:px-2">
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-surface-50/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-surface-900 dark:text-surface-50 tracking-tight">
              Everything you need
            </h2>
            <p className="mt-2 sm:mt-3 text-base sm:text-lg text-surface-600 dark:text-surface-300 max-w-xl mx-auto px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {features.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="group relative bg-white dark:bg-surface-900 rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-7 border border-surface-200/80 shadow-card hover:shadow-card-hover hover:border-brand-200/60 transition-all duration-300"
              >
                ...
                <h3 className="text-base sm:text-lg font-semibold text-surface-900 dark:text-surface-50">{title}</h3>
                <p className="mt-1.5 sm:mt-2 text-sm text-surface-600 dark:text-surface-300 leading-relaxed">{description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* How it works */}
      <section id="how-it-works" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-surface-900 border-t border-surface-100 dark:border-surface-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-surface-900 dark:text-surface-50 tracking-tight">
              How it works
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            <div className="text-center px-2">
              ...
              <h3 className="mt-1.5 sm:mt-2 text-base sm:text-lg font-semibold text-surface-900 dark:text-surface-50">Clock in & out</h3>
              <p className="mt-1.5 sm:mt-2 text-surface-600 dark:text-surface-300 text-sm leading-relaxed">
                Employees start and end their work sessions with one tap. Times are stored instantly and shown on their dashboard.
              </p>
            </div>
            <div className="text-center px-2">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-surface-100 dark:bg-surface-800 text-surface-600 dark:text-surface-300 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <BarChart3 className="w-6 h-6 sm:w-7 sm:h-7" />
              </div>
              <span className="text-xs sm:text-sm font-semibold text-surface-500 dark:text-surface-400 dark:text-surface-500">Step 2</span>
              <h3 className="mt-1.5 sm:mt-2 text-base sm:text-lg font-semibold text-surface-900 dark:text-surface-50">Hours are calculated</h3>
              <p className="mt-1.5 sm:mt-2 text-surface-600 dark:text-surface-300 text-sm leading-relaxed">
            ...
            <div className="text-center px-2">
              ...
              <span className="text-xs sm:text-sm font-semibold text-surface-500 dark:text-surface-400 dark:text-surface-500">Step 3</span>
              <h3 className="mt-1.5 sm:mt-2 text-base sm:text-lg font-semibold text-surface-900 dark:text-surface-50">Export & pay</h3>
              <p className="mt-1.5 sm:mt-2 text-surface-600 dark:text-surface-300 text-sm leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              ...
              <p className="mt-1 text-xs sm:text-sm text-surface-400 dark:text-surface-500">Hours tracked weekly</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white tabular-nums">50+</p>
              <p className="mt-1 text-xs sm:text-sm text-surface-400 dark:text-surface-500">Teams</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white tabular-nums">99%</p>
              <p className="mt-1 text-xs sm:text-sm text-surface-400 dark:text-surface-500">Uptime</p>
            </div>
            <div>
              <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white tabular-nums">1 tap</p>
              <p className="mt-1 text-xs sm:text-sm text-surface-400 dark:text-surface-500">To clock in</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="for-teams" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-surface-50/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-surface-900 dark:text-surface-50 tracking-tight px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-white dark:bg-surface-900 rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 border border-surface-200/80 shadow-card">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-surface-900 dark:text-surface-50">For employees</h3>
              <p className="mt-2 sm:mt-3 text-surface-600 dark:text-surface-300 text-sm leading-relaxed">
              ...
              <ul className="mt-4 sm:mt-5 space-y-2 text-sm text-surface-700 dark:text-surface-200">
            ...
            <div className="bg-white dark:bg-surface-900 rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 border border-surface-200/80 shadow-card">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-surface-100 dark:bg-surface-800 text-surface-600 dark:text-surface-300 flex items-center justify-center mb-4 sm:mb-5">
                <Users className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-surface-900 dark:text-surface-50">For admins</h3>
              <p className="mt-2 sm:mt-3 text-surface-600 dark:text-surface-300 text-sm leading-relaxed">
      ...
      {/* CTA */}
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-surface-900 border-t border-surface-100 dark:border-surface-800">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-surface-900 dark:text-surface-50 tracking-tight px-2">
            Ready to track time the simple way?
          </h2>
          <p className="mt-2 sm:mt-3 text-sm sm:text-base text-surface-600 dark:text-surface-300 px-2">
      ...
      {authOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
            <div
              className="bg-white dark:bg-surface-900 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-md my-auto overflow-hidden transition-all duration-200 scale-100 opacity-100 max-h-[calc(100vh-1.5rem)] flex flex-col"
            ...
            >
              <div className="p-4 sm:p-6 border-b border-surface-100 dark:border-surface-800 flex items-center justify-between shrink-0">
                ...
                <button
                  type="button"
                  onClick={() => setAuthOpen(false)}
                  className="p-2 rounded-lg text-surface-400 dark:text-surface-500 hover:bg-surface-100 dark:hover:bg-surface-700 dark:bg-surface-800 hover:text-surface-600 dark:text-surface-300 transition-colors touch-manipulation"
                  aria-label="Close"
                >
                  <X className="w-5 h-5" />
                </button>
              ...
              <div className="p-4 sm:p-6 overflow-y-auto">
                ...
                <form onSubmit={handleAuthSubmit} className="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 p-1 rounded-lg bg-surface-100 dark:bg-surface-800">
                      <button
                        type="button"
                        onClick={() => setRole('employee')}
                        className={clsx(
                          'flex-1 py-2 rounded-md text-sm font-medium flex items-center justify-center gap-1.5 sm:gap-2 min-h-[2.5rem]',
                          role === 'employee' ? 'bg-white dark:bg-surface-900 shadow-sm text-surface-900 dark:text-surface-50' : 'text-surface-600 dark:text-surface-300'
                        )}
                      >
                      ...
                      <button
                        ...
                        className={clsx(
                          'flex-1 py-2 rounded-md text-sm font-medium flex items-center justify-center gap-1.5 sm:gap-2 min-h-[2.5rem]',
                          role === 'admin' ? 'bg-white dark:bg-surface-900 shadow-sm text-surface-900 dark:text-surface-50' : 'text-surface-600 dark:text-surface-300'
                        )}
                      >
