...
export default function AdminAttendance() {
  ...
  function exportCSV() {
    ...
    // 10JUN2026 — DR site-manager standardized template (Harmony Attendance
    // Export Template.csv). 16 columns, ALL CAPS, no hours buckets, no
    // comments. The leading space in " CLOCK OUT" is intentional — kept
    // byte-for-byte to match the manager's reference file so any downstream
    // importers keyed on that exact header continue to work.
    const headers = [
      'RECORD ID',
      'EID',
      'EMPLOYEE NAME',
